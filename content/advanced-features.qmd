...
pkfitfinal <- readRDS(here::here("content", data_directory, "pkfitfinal.RDS"))
pkfit0 <- readRDS(here::here("content", data_directory, "pkfit0.RDS"))
parfinal <- pkfitfinal$obj$env$parList()
pkinput0 <- readRDS(here::here("content", data_directory, "pkinput0.RDS"))
fimsdat <- pkdat0 <- pkinput0$dat
pkinput <- readRDS(here::here("content", data_directory, "pkinput.RDS"))
```
...
source(here::here("content", function_directory, "pk_prepare_FIMS_inputs.R"))
...
# saveRDS(mcmc, file = here::here("content", data_directory, "pk_mcmcfit.RDS"))

mcmc <- readRDS(here::here("content", data_directory, "pk_mcmcfit.RDS"))
...
saveRDS(
  ssbpost,
  file = here::here("content", data_directory, "pk_SSB_posteriors.RDS")
)
ssbpost <- readRDS(
  here::here("content", data_directory, "pk_pollock_SSB_posteriors.RDS")
)
...
years <- 500:1000
source(here::here("content", function_directory, "pk_prepare_FIMS_inputs_old.R"))
years <- 1970:2023
