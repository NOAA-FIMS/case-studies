...
# this creates the .Rdata file which is included with the case studies but is not run when rendering the case study. The code is included here for transparency and reproducibility but is not intended to be run by users of the case study.
if (FALSE) {
...
} # end if (FALSE) for code used to prepare .Rdata
```
