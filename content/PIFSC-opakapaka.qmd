...
default_parameters <- FIMS::setup_default_parameters(data = data_4_model)

# TODO: Change to parametric growth instead of EWAA in the default configuration
...
parameters <- default_parameters |>
  ...
  # # update the growth parameters with initial values from SS3 (depends on in-development growth module)
  # dplyr::rows_update(
  #   tibble::tibble(
  #     module_name = "Growth",
  #     label = c(
