...
# TODO: change fleet1, survey2 and survey6 to be DoubleLogistic
default_parameters <- FIMS::setup_default_parameters(data = data_4_model) |>
  ...
  dplyr::rows_update(
    tibble::tibble(
      module_name = "Population",
      timing = rep(years, each = FIMS::get_n_ages(data_4_model)),
  ...
  dplyr::rows_update(
    tibble::tibble(
      module_name = "Fleet",
      fleet = c("survey2", "survey3", "survey6"),
      label = "log_q",
  ...
  dplyr::filter_out(
    ...
    fleet %in% c("fleet1", "survey2", "survey6")
  )
...
FIMS::get_data(data_4_model) |>
  dplyr::filter(fleet == "fleet1", type == "age_comp") |>
  print(n = 10)
