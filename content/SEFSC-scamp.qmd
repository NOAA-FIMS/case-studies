...
library(FIMS) # Updated to latest fims on 6/6/24
library(TMB)
library(tidyverse)
...
sca <- dget("scamp32o.rdat") # get scamp data and output from simplified version of BAM
...
savePlot(filename = paste(out.folder, "/Plot_tseries_fits.", plot.type, sep = ""), type = c(plot.type))
...
savePlot(filename = paste(out.folder, "/Plot_tseries_F.", plot.type, sep = ""), type = c(plot.type))
...
savePlot(filename = paste(out.folder, "/Plot_selex.", plot.type, sep = ""), type = c(plot.type))
...
savePlot(filename = paste(out.folder, "/Plot_tseries_popn.", plot.type, sep = ""), type = c(plot.type))

######################################################################
windows(width = 8, height = 11, record = T)
...
savePlot(filename = paste(out.folder, "/Plot_caa_fleet1.", plot.type, sep = ""), type = c(plot.type))
...
savePlot(filename = paste(out.folder, "/Plot_caa_fleet2.", plot.type, sep = ""), type = c(plot.type))
...
savePlot(filename = paste(out.folder, "/Plot_caa_survey.", plot.type, sep = ""), type = c(plot.type))
...
![Fits-tseries](Figures/Plot_tseries_fits.png){width=7in, fig-align="left"} 

![Fits-CAA-fleet1](Figures/Plot_caa_fleet1.png){width=7in, fig-align="left"}

![Fits-CAA-fleet2](Figures/Plot_caa_fleet2.png){width=7in, fig-align="left"}

![Fits-CAA-survey](Figures/Plot_caa_survey.png){width=7in, fig-align="left"}

![Predicted-selex](Figures/Plot_selex.png){width=7in, fig-align="left"}

![Predicted-tseries-F](Figures/Plot_tseries_F.png){width=7in, fig-align="left"}

![Predicted-tseries-population](Figures/Plot_tseries_popn.png){width=7in, fig-align="left"}
