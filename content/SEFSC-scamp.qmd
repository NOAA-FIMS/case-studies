...
fleet1_landings_df <- data.frame(
  ...
  uncertainty = fleet1_landings_cv
)
...
fleet2_landings_df <- data.frame(
  ...
  unit = "mt",
  uncertainty = fleet2_landings_cv
  ...
  update_parameters(
    modified_parameters = list(
      fleet1 = list(
        ...
        #          we ever use it?
        # DlnormDistribution.log_sd.value = fleet1_landings_logSD
      ...
      fleet2 = list(
        ...
        # DlnormDistribution.log_sd.value = fleet2_landings_logSD
        # DlnormDistribution.log_sd.value = get_data(data_4_model) |>
      ...
      survey1 = list(
        ...
        # DlnormDistribution.log_sd.value = survey_index_logSD
        # DlnormDistribution.log_sd.value = get_data(data_4_model) |>
  ...
  update_parameters(
    modified_parameters = list(
      ...
      recruitment = list(
        ...
        BevertonHoltRecruitment.logit_steep.value = 0.999,
        # BevertonHoltRecruitment.logit_steep.value = -log(1.0 - 0.999) + log(0.999 - 0.2),
