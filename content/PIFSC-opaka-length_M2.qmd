...
How can I plot things like maturity curve, growth curve, selectivity, etc. to check those? In our model they are length-based processes so I converted (aka eye-balled logistic curves that look like they match for ages) to values that I think would be roughly equivalent in ages. Eventually, having length-based processes would be necessary for this model. 
