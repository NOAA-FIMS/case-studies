...
# data_4_model <- FIMS::FIMSFrameAge(fimsdat) #Cannot be FIMSFrame

# fishery_catch <- FIMS::m_landings(data_4_model)
# fishery_agecomp <- FIMS::m_agecomp(data_4_model, "fleet1")
# survey_index <- FIMS::m_index(data_4_model, "survey1")
# survey_agecomp <- FIMS::m_agecomp(data_4_model, "survey1")
...
# fish_age_comp$age_comp_data <- data_4_model@data |>
...
# survey_age_comp$age_comp_data <- data_4_model@data |>
